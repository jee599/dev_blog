...
### Label Conservatism as a Hard Constraint
...
I analyzed what established learning platforms do — Inflearn, Class101, FastCampus — and the visual language became clearer. It's not about aesthetic trends. It's about information architecture that reduces uncertainty for someone asking whether to spend time and money here. That analysis triggered another redesign pass.
...
The distribution reflects the shape of the work. Cron automation — short, structured, repetitive — produces a Read-heavy, Edit-heavy fingerprint. Parallel design work produces an Agent-heavy, Bash-heavy fingerprint. The tool histogram is a reliable indicator of task type.

What this session reinforced: **multi-agent parallelism is a time multiplier, but only after you have a direction worth parallelizing.** Get the direction right first. Then scale.
