...
If you've tried multi-agent workflows and hit conflicts, this is almost certainly why — work was divided by feature instead of by file. The fix is to define scope at the file boundary before dispatching.
