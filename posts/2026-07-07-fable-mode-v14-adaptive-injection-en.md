...
published: true
description: "After open-sourcing a hook that makes Opus act like Fable, I made the per-turn norm injection adaptive, replaced a trust-based fix with a grep guard, and re-measured the cost honestly."
...
v1.4 fixes both. And while I was in there, I took a regression I had papered over with trust and sealed it with code instead. Here's what each change actually was, and what re-measuring honestly did to my pretty number.
...
Full Korean analysis on [spoonai.me](https://spoonai.me/blog/fable-mode-v14-adaptive-injection).
