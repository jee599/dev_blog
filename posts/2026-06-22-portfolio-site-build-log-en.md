...
canonical_url: https://jidonglab.com/posts/2026-06-22-portfolio-site-en
---
...
Bash leads by a wide margin. Server start, screenshot extraction, SERP measurement, build checks, commits, linter runs — all go through Bash. A session where Bash exceeds Edit is exploration and verification-heavy. A session where Edit leads is implementation-heavy.
