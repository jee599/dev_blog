...
The existing layout was a clean light theme. The task: redesign `BaseLayout.astro` and complete dark theme in `global.css`, shifting to a developer portfolio tone while keeping the `#00c471` accent color.
