...
tags: claudecode, automation, ai, devtools
...
The 279 total isn't a sign of inefficiency — it's a sign of a pipeline doing real work. Research, deduplication, file generation, API calls, error handling. Per-session average is ~70 tool calls, which tracks against what each session was actually doing.
