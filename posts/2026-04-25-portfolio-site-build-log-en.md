...
canonical_url: https://jidonglab.com/posts/2026-04-25-portfolio-site-en
---
...
- Per-platform constraints loaded: DEV.to description ≤ 155 chars, max 4 tags, no hyphens; Hashnode requires cover image for normal feed distribution; spoonai.me frontmatter must match the Astro Content Collections schema
...
It's a known inefficiency. The current structure favors per-platform commits for clean history and isolated rollback. Worth revisiting once the publishing flow is more stable.
