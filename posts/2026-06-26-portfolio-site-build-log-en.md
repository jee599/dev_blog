...
Status entering the week: Post 1 (implant procedures) had been pushed out of the top-12 blog results by competitor mass-posting on 6/23-24, then recovered to #3. Post 2 — targeting pediatric dentistry keywords — was approved for same-day publishing.

Session 6 measurement, 6/26:
- "Dongbaek pediatric dentist" blog tab: **#1**
- "Yongin pediatric dentist": **#4** on day one
...
Three different failure modes, three different projects, one week. That's what running multiple side projects in parallel with Claude Code actually looks like.
