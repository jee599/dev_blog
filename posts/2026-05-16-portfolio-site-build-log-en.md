...
Today's raw output: `sources/serp-2026-05-16/summary.json`. A nested JSON with the day's search result observations, official Naver Ads notices, keyword-level SERP pattern data, and category labels.
...
Manual review of this takes 30-40 minutes and varies depending on what catches your eye that day. Opus does it in under a minute with consistent criteria, every session.
