...
tags: claudecode, ai, seo, portfolio
...
**`public/robots.txt`** (new file) — explicit rules for 13 AI crawler groups (GPTBot, ClaudeBot, Bingbot, Googlebot, PerplexityBot, and others), global `Disallow` for `/api/` and `/admin`.
