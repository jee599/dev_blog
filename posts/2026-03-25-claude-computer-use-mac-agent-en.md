...
published: true
description: "Anthropic's Computer Use turns Claude into a remote desktop agent. It opens apps, fills spreadsheets, and browses the web — all from your phone. Here's what works and what doesn't."
...
If you've been following Anthropic's recent releases, you'll know about Dispatch — the feature that lets you message Claude from your phone and assign tasks to your Mac.

{% link jee599/claude-dispatch-cowork-setup-en %}
...
The system runs inside Anthropic's Cowork environment, which provides the sandboxing and security layer.

{% link jee599/claude-code-channels-architecture-setup-en %}
