...
First step: analyze the target site. It turned out to be a **1:1 mentoring platform for the Korean game industry** — coffee chats, resume reviews, mock interviews with industry professionals. Not a social app. Not a generic chat product. A structured ed-tech/mentoring service.
...
Accurate. The word "coffee chat" pulled the direction toward casual and social. The actual positioning is closer to Inflearn or Teachable — credibility-first, professional education services. After reclassifying the service category, round 2 started fresh with ed-tech platform references as the baseline.
