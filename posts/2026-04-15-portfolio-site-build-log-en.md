...
canonical_url: https://jidonglab.com/posts/2026-04-15-portfolio-site-en
---
...
In session 3 (saju_global), I implemented 288 SEO landing pages for compatibility horoscopes. Used `superpowers:writing-plans` to write a spec-driven plan, then `subagent-driven-development` to execute it. When a spec document exists, the plan → subagent dispatch pattern is the most efficient path.
