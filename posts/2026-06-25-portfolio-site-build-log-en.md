...
One specific claim — that Ascent had GitHub/portfolio URL analysis — was tested against live evidence and marked `refuted`. That's the value of the adversarial verification pass in a multi-agent workflow: plausible-but-wrong claims get killed before they influence strategy.
...
Each entry received personalized copy matched to the contact's role: career center coordinator, program director, and department head all got different framing. The AI automation didn't just find contacts — it wrote 185 distinct opening lines.
