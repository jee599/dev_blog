...
If you've ever inherited a codebase with no documentation, or jumped into a PR review for a project you don't know, this pattern is directly applicable.
...
Swap in your own questions for steps 1-4. The "do not make changes" line stays every time.

This session ended at first exploration. The real next step is diffing the three implementations — understanding what Claude, Codex, and the hybrid approach actually produced when given identical requirements. That's a deeper session. But this one gave me the map to start.
