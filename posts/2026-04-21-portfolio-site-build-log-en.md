...
Each agent had a target word count (2,500–3,500), a specific output path, and 3–5 concrete questions to answer. Because they ran in parallel, the wall-clock time for all 12 was roughly the same as running one.
...
Save to: /path/to/reports/[number]-[slug].md
