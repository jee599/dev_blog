...
Responsive layout improvements also shipped: `HomeContent.tsx`, `ArticleCard.tsx`, and `globals.css` updated to widen the layout on desktop and adapt properly on mobile.
