...
published: true
description: "무료 분석 1건에 $0.085. 하루 1,000명이면 월 $2,550. 무료인데 돈이 나간다."
tags: [llm, ai, costoptimization, saas]
series: "AI 사주 앱 빌드 로그"
---

> **TL;DR** — 프롬프트 캐싱, 모델 라우팅, Structured Output. 이 세 가지로 월 $3,316 → $406.
> 사주 앱이 아니어도 LLM 쓰는 서비스라면 거의 그대로 적용 가능하다.
...
세 가지 전략이 독립적이라서 순서대로 적용해도 되고, 동시에 적용해도 된다. 사주 앱이 아니라 어떤 LLM 기반 서비스든 이 세 가지는 거의 그대로 적용할 수 있다.
