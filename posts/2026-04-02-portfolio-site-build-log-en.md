...
canonical_url: https://jidonglab.com/posts/2026-04-02-portfolio-site-en
---
...
Claude Code searched everywhere. `~/.devto`, `~/.config/devto`, every `.env*` file in the project, macOS Keychain, shell environment variables. Four background tasks running in parallel, all returning nothing.
