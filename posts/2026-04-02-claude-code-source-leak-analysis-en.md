...
published: true
description: "I analyzed the full TypeScript source of Claude Code after Anthropic accidentally shipped 59.8MB of source maps in npm. Here's what KAIROS, anti-distillation, and the architecture reveal."
...
{% link jee599/anthropics-claude-mythos-leak-crashed-crowdstrike-7-3dh2 %}
...
{% link jee599/writing-a-claude-code-book-with-claude-code-when-posttooluse-hooks-loop-25-times-1g4h %}
...
{% link jee599/how-i-built-spoonai-with-claude-code-hooks-1m2n %}
...
Full Korean analysis on [spoonai.me](https://spoonai.me/posts/claude-code-source-leak-analysis)
