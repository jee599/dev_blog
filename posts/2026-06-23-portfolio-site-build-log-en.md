...
tags: claudecode, ai, javascript, productivity
...
**Session 2 (13 min, 1 tool call):** Dental clinic keyword ranking check — fully delegated to a `dental-clinic` sub-agent. The sub-agent handled placement ranking measurement, history file update, and git push internally. Sub-agent internals don't appear in the main session's tool call count. One tool call for the entire task.
