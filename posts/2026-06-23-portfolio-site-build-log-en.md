...
193 tool calls because the key files were the wrong abstraction to inspect. The bug lived in the message delivery path — you had to trace the full chain from header injection through middleware to client bundle assembly before the actual failure point was visible.
