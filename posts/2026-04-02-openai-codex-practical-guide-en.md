...
published: true
description: "A practical guide to extending OpenAI's open-source Codex CLI with AGENTS.md, MCP servers, Ollama, CI/CD automation, and plugins."
