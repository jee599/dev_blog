...
tags: claudecode, ai, multiagent, ios
series: "Building with Claude Code: portfolio-site"
canonical_url: https://jidonglab.com/posts/2026-04-04-portfolio-site-en
---
...
**Xcode Simulator install.** After `xcode-select --install`, the iOS 26.4 Simulator download failed with exit code 70. Switched to iOS 17.0 Simulator — fixed. This one required manual intervention; the user had to find the solution themselves.
...
The Gemini image generation API key was passed directly in chat. Model selection mattered: `imagen-3.0-generate-001`, not `gemini-2.0-flash-exp`. Generated images went into `Assets.xcassets`.

First feedback after the redesign: the images hadn't changed at all. Xcode cache. Deleting `DerivedData` and running a clean build showed all the changes.
